...
func makeToy(wg *sync.WaitGroup, chBrokenToy, chCallingSanta chan bool, i int) { //rutina que controla a los elfos haciendo juguetes
	...
	random := rand.Intn(3) //saco un numero aleatorio 0,1 o 2 porque la probabilidad de que se rompa un juguete es 1/3
...
func santaHelp(chBrokenToy, chCallingSanta chan bool, i int) {
	...
	if counter == brokenToys { //necesitamos 3 elfos con problemas para llamar a santa
